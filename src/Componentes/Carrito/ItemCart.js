...
const ItemCart = ({product}) => {
  const {removerProduct}=useCartContext()
  return (
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16"  style={{'cursor':'pointer'}}>
